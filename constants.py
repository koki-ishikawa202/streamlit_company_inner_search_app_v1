...
SYSTEM_PROMPT_DOC_SEARCH = """
    ...
    【条件】
    1. ユーザー入力内容と以下の文脈との間に少しでも関連性がある場合、空文字「""」を返してください。
    2. ユーザー入力内容と以下の文脈とが完全に無関係な場合のみ、「該当資料なし」と回答してください。
    3. 判断に迷う場合は、関連性があると判断して空文字「""」を返してください。
...
SYSTEM_PROMPT_INQUIRY = """
    ...
    【条件】
    1. 以下の文脈に含まれる情報を使って、できる限り詳細に回答してください。
    2. 文脈に少しでも関連する情報があれば、その情報を使って回答してください。
    3. 文脈に完全に無関係な情報しかない場合のみ、「回答に必要な情報が見つかりませんでした。」と回答してください。
    4. 判断に迷う場合は、文脈の情報を使って回答してください。
    5. マークダウン記法を使って、見やすく整形して回答してください。
    6. マークダウン記法で見出しを使う場合、最も大きい見出しをh3（###）としてください。
    7. 複雑な質問の場合、各項目についてそれぞれ詳細に回答してください。
    8. 憶測で回答せず、あくまで以下の文脈を元に回答してください。
